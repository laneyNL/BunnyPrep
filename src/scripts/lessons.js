...
export default class Lesson {
  ...
  lesson0(){
    this.longDirections = `You can move ${this.bunny.name} around with your cursor or the arrow keys. Trying moving ${this.bunny.name} to the litterbox. Earn hearts and money by completing tasks.`;
  ...
  lesson1() {
    this.longDirections = `You have moved ${this.bunny.name} to the litter box! <br>Bunnies eat hay all day. Keep an eye on the hay pile and refill it often. Each refill will cost $5. ${this.bunny.name} will lose hearts if the hay is gone. <br>Try clicking 'Add Hay' button.`;
    this.form = `<input type="submit" value='Continue'>`;
  ...
  lesson2() {
    ...
    this.longDirections = `Great job on adding hay! <br>Now it's time to feed ${this.bunny.name} some fresh veggies. Select which items would you like to feed ${this.bunny.name}. Each vegetable will cost $1. <br>Afterwards, move ${this.bunny.name} to the food bowl`;
  ...
  lesson3() {
    ...
    this.longDirections += `<br>Now bring ${this.bunny.name} to the water bowl to get some water.`
    this.form = `<input type="submit" value='Continue'>`;
